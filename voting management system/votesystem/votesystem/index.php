...
<div class="login-box" style="background-color:#B0C4DE ;color:white ; font-size: 22px; font-family:Times">
  	<div class="login-logo" style="background-color:#B0C4DE ;color:white ; font-size: 22px; font-family:Times  ">
  		<b> Online Voting System</b>
  	</div>
  
  	<div class="login-box-body" style="background-color:#B0C4DE ;color:white ; font-size: 22px; font-family:Times" >

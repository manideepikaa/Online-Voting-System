<aside class="main-sidebar "style="background-color: #bddeff ">
  <!-- sidebar: style can be found in sidebar.less -->
  <section class="sidebar" style="background-color: #bddeff">
    <!-- Sidebar user panel -->
    ...
    <ul class="sidebar-menu pull-left" data-widget="tree" style="background-color: #bddeff ; color:white ; font-size: 15px; font-family:Times  " >
      <!-- <li class="header" style="background-color: #28272D ;color:white ; font-size: 12px; font-family:Times  ">REPORTS</li> -->
      <li class=""><a href="home.php"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
      <li class=""><a href="votes.php"><i class=" fa fa-lock"></i> <span>List of Votes Casted</span></a></li>
      <li class="header" style=" font-size: 16px;font-weight:bolder; font-family:Times ">Manage</li>
      ...
      <li class="header" style="font-size: 16px; font-family:Times;font-weight:bolder">Election Settings</li>

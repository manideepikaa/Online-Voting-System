      ...
      <div class="col-lg-3 col-xs-6" style=" font-family:Times">
        ...
        <div class="col-lg-3 col-xs-6" style=" font-family:Times">
          ...
          <div class="small-box bg-green">
            ...
            <a href="candidates.php" class="small-box-footer" style="background-color:	#4682B4 ;color:black ; font-size: 18px">More info <i class="fa fa-arrow-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6" style=" font-family:Times">
          ...
          <div class="inner" style="background-color: #B0C4DE ;color:black ; font-size:15px; font-family:Times">
              <?php
            ...
            <a href="voters.php" class="small-box-footer "style="background-color:  #4682B4 ;color:black ; font-size: 18px">More info <i class="fa fa-arrow-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6" style="color:black ; font-size: 15px; font-family:Times">
          ...
          <div class="inner" style="background-color: #B0C4DE ;color:black ; font-size:15px; font-family:Times">
            ...
            <a href="votes.php" class="small-box-footer "style="background-color: #4682B4 ;color:black ; font-size: 18px">More info <i class="fa fa-arrow-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
        ...
        <div class="col-xs-12" >
          <h3> <b>VOTES TALLY
            <span class="pull-right">
              ...
              <a href="print.php" class="btn btn-success btn-sm btn-curve" style="background-color: #f3f3f3 ;color:black ; font-size: 12px; font-family:Times "><span class="glyphicon glyphicon-print"></span> Print</a>
            </span>
         </b> </h3>
        </div>
      </div>
      ...
      <?php
        ...
        while($row = $query->fetch_assoc()){
          ...
          echo "
           ...
           <div class='col-sm-6'  > 
              <div class='box box-solid' style='background-color: #f3f3f3' >
                <div class='box-header with-border' style='background-color: #f3f3f3'>
                  <h4 class='box-title'><b>".$row['description']."</b></h4>
                </div>
                <div class='box-body' style='background-color: #f3f3f3'>
                  <div class='chart' style='background-color: #f3f3f3'>

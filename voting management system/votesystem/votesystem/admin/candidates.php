        ...
        <div class="col-xs-12">
          <div class="box" style="background-color: #f3f3f3">
            <div class="box-header with-border" style="background-color: #f3f3f3">
              <a href="#addnew" data-toggle="modal" class="btn btn-primary btn-sm btn-curve" style="background-color: #f3f3f3 ;color:black ; font-size: 12px; font-family:Times"><i class="fa fa-plus"></i> New</a>
            </div>
            <div class="box-body">
